...
public class IPLFactAnalyserTeamTest {
    ...
    public void givenIPLFactsSheetOfMostRunsFile_WhenProper_ShouldGiveCorrectCount() {
        ...
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLRunnsAdapter());
    ...
    public void givenNoFile_ShouldHandleException() {
        ...
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLRunnsAdapter());
            iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BATTING, "");
    ...
    public void givenEmptyFile_ShouldHandleException() {
        ...
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLRunnsAdapter());
            iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BATTING, EMPTY_FILE);
        } catch (IPLFactAnalyserException e) {
            Assert.assertEquals(IPLFactAnalyserException.ExceptionType.SOME_FILE_ISSUE, e.type);
        } catch (CSVBuilderException e) {
        }
    ...
    public void givenIPLFactsSheetOfMostRunsFile_WhenDelimeterIssue_ShouldHandleException() {
        ...
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLRunnsAdapter());
            iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BATTING, DELIMETER_BATTING_FILE);
        } catch (IPLFactAnalyserException e) {
            Assert.assertEquals(IPLFactAnalyserException.ExceptionType.SOME_FILE_ISSUE, e.type);
        } catch (CSVBuilderException e) {
        }
    ...
    public void givenIPLFactsSheetsOfMostRunsFile_WhenHeaderIssue_ShouldHandleException() {
        ...
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLRunnsAdapter());
            iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BATTING, HEADER_BATTING_FILE);
        } catch (IPLFactAnalyserException e) {
            Assert.assertEquals(IPLFactAnalyserException.ExceptionType.SOME_FILE_ISSUE, e.type);
        } catch (CSVBuilderException e) {
        }
    ...
    public void givenIPLFactsSheetOfMostRunsFile_WhenGivenFileTypeIsNotSupported_ShouldHandleException() {
        ...
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLRunnsAdapter());
            iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BATTING, BATTING_FILE_TYPE_NOT_SUPPORTED);
        } catch (IPLFactAnalyserException e) {
    ...
    public void givenIPLFactsSheetOfMostRunsFile_WhenFilePathIsIncorrect_ShouldHandleException() {
        ...
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLRunnsAdapter());
            iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BATTING, BATTING_FILE_PATH_INCORRECT);
        } catch (IPLFactAnalyserException e) {
            Assert.assertEquals(IPLFactAnalyserException.ExceptionType.CENSUS_FILE_PROBLEM, e.type);
        } catch (CSVBuilderException e) {
        }
    ...
    public void givenIPLFactsSheetMostOfWktsFile_WhenGivenProper_ShouldReturnCorrectCount() {
        IPLFactAnalyserTeam iplFactAnalyserTeam = new IPLFactAnalyserTeam();
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLWktsAdapter());
            int result = iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BOWLING, IPL_BOWLING_TEAM);
    ...
    public void givenNoFile_ProperlyShouldHandleException() {
        ...
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLWktsAdapter());
            iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BOWLING, "");
        } catch (IPLFactAnalyserException e) {
            Assert.assertEquals(IPLFactAnalyserException.ExceptionType.SOME_FILE_ISSUE, e.type);
        } catch (CSVBuilderException e) {
        }
    ...
    public void givenEmptyFile_ProperlyShouldHandleException() {
        ...
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLWktsAdapter());
            iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BOWLING, EMPTY_FILE);
        } catch (IPLFactAnalyserException e) {
            Assert.assertEquals(IPLFactAnalyserException.ExceptionType.SOME_FILE_ISSUE, e.type);
        } catch (CSVBuilderException e) {
        }
    ...
    public void givenIPLFactsSheetOfMostWktsFile_WhenDelimeterIssue_ShouldHandleException() {
        ...
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLWktsAdapter());
            iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BOWLING, DELIMETER_BALLING_FILE);
        } catch (IPLFactAnalyserException e) {
            Assert.assertEquals(IPLFactAnalyserException.ExceptionType.SOME_FILE_ISSUE, e.type);
        } catch (CSVBuilderException e) {
        }
    ...
    public void givenIPLFactSheetsOfMostWktsFile_WhenHeaderIssue_ShouldHandleException() {
        ...
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLWktsAdapter());
            iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BOWLING, HEADER_BALLING_FILE);
        } catch (IPLFactAnalyserException e) {
            Assert.assertEquals(IPLFactAnalyserException.ExceptionType.SOME_FILE_ISSUE, e.type);
        } catch (CSVBuilderException e) {
        }
    ...
    public void givenIPLFactsSheetOfMostWktsFile_WhenGivenFileTypeIsNotSupported_ShouldHandleException() {
        ...
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLWktsAdapter());
            iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BOWLING, BALLING_FILE_TYPE_NOT_SUPPORTED);
        } catch (IPLFactAnalyserException e) {
            Assert.assertEquals(IPLFactAnalyserException.ExceptionType.CENSUS_FILE_PROBLEM, e.type);
        } catch (CSVBuilderException e) {
        }
    ...
    public void givenIPLFactsSheetOfMostWktsFile_WhenFilePathIsIncorrect_ShouldHandleException() {
        ...
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLWktsAdapter());
            iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BOWLING, BALLING_FILE_PATH_INCORRECT);
        } catch (IPLFactAnalyserException e) {
            Assert.assertEquals(IPLFactAnalyserException.ExceptionType.CENSUS_FILE_PROBLEM, e.type);
        } catch (CSVBuilderException e) {
        }
    ...
    public void givenIPLFactsSheetOfMostWktsFile_WhenSortedOnAverage_ShouldReturnTopBowlingAvearages() {
        try {
            ...
            IPLFactAnalyserTeam iplFactAnalyserTeam = new IPLFactAnalyserTeam();
            iplFactAnalyserTeam.setIplAdapter(new IPLWktsAdapter());
            iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BOWLING, IPL_BOWLING_TEAM);
            String sortedData = iplFactAnalyserTeam.getSortedData(SortFieldIplTeam.AVERAGE);
    ...
    public void givenIPLFactsSheetsOfMostRunnsAndWktsFiles_WhenGivenCorrect_ShouldReturnCorrectCount() {
        IPLFactAnalyserTeam iplFactAnalyserTeam = new IPLFactAnalyserTeam();
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLRunnsWktsAdapter());
            int result = iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BATTING, IPL_BATTING_TEAM, IPL_BOWLING_TEAM);
    ...
    public void givenIPLFactsSheetsOfMostRunnsAndWktsFiles_WhenSorted_ShouldReturnMostBallingAndBattingAvearge() {
        ...
        try {
            iplFactAnalyserTeam.setIplAdapter(new IPLRunnsWktsAdapter());
            iplFactAnalyserTeam.loadIplData(IPLFactAnalyserTeam.IPLTeams.BATTING, IPL_BATTING_TEAM, IPL_BOWLING_TEAM);
